# -*- coding: utf-8 -*-
"""MD4 for Kad. Many Python installs (OpenSSL 3) ship md4 disabled
in hashlib, so a pure-Python implementation is included as a fallback."""
import struct
...
def md4(data):
    """Returns the MD4 digest (16 bytes) of 'data'. Uses hashlib if supported."""
    try:
        import hashlib
        h = hashlib.new("md4")
        h.update(data)
